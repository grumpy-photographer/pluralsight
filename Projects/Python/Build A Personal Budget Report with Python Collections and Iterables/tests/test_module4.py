...
def test_task1_module4():
    ...
    assert (
        cat_def_found
    ), "Did you define the method `def categorize_set_comprehension(self)`?"
...
def test_task2_module4():
                        ...
                        if (
                            ...
                            for z in y.body:
                                ...
                                if "necessary_expenses:x:x:self:list" in assignments[0]:
                                    ...
                                    if (
                                        "x:category:Phone" in assignments[0]
                                        and "x:category:Auto and Gas" in assignments[0]
                                        and "x:category:Classes" in assignments[0]
                                        and "x:category:Utilities" in assignments[0]
                                        and "x:category:Mortgage" in assignments[0]
                                    ):
    ...
    assert (
        necessary_expenses_checks_found
    ), "Did you assign `necessary_expenses` to a set comprehension with all of the category checks?"
...
def test_task3_module4():
                        ...
                        if (
                            ...
                            for z in y.body:
                                ...
                                if "food_expenses:x:x:self:list" in assignments[0]:
                                    ...
                                    if (
                                        "x:category:Groceries" in assignments[0]
                                        and "x:category:Eating Out" in assignments[0]
                                    ):
    ...
    assert (
        food_expenses_checks_found
    ), "Did you assign `food_expenses` to a set comprehension with all of the category checks?"
...
def test_task4_module4():
                        ...
                        if (
                            ...
                            for z in y.body:
                                ...
                                if (
                                    ...
                                    in assignments[0]
                                    and "necessary_expenses" in assignments[0]
    ...
    assert (
        unnecessary_expenses_found
    ), "Did you create the variable `unnecessary_expenses`? It should be initialized to `set(self.list)` minus `necessary_expenses` minus `food_expenses`."
...
def test_task5_module4():
                    ...
                    for y in x.body:
                        if (
                            ...
                            for z in y.body:
                                ...
                                if (
                                    "necessary_expenses:food_expenses:unnecessary_expenses"
                                    in returns
                                ):
                                    return_found = True
    ...
    assert (
        return_found
    ), "Did you return `[necessary_expenses, food_expenses, unnecessary_expenses]`?"
...
def test_task6_module4():
    ...
    assert (
        "divided_set_comp:expenses:categorize_set_comprehension" in assignments
    ), message
...
def test_task7_module4():
    ...
    if_found = (
        "divided_set_comp:divided_for_loop:print:Sets are NOT equal by == test" in ifs
        or "divided_for_loop:divided_set_comp:print:Sets are NOT equal by == test"
        in ifs
    )
